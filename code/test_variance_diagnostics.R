...
for(jrep in 1:nreps){
	...
	sd_vals3 = 1 + 0.4*dnorm(fitted_vals,mean=1,sd=0.25); 
...
save.image(file="test_variance_diagnostics_500_levene2.Rdata"); 
...
dev.copy2pdf(file="../manuscript/figures/test_variance_diagnostics_500_levene2.pdf"); 
