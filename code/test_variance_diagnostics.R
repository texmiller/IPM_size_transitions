...
N = 5000; ## number of fitted values 
...
for(jrep in 1:nreps){
	...
	sd_vals3 = 1 + 0.1*dnorm(fitted_vals,mean=1,sd=0.25)/dnorm(1,1,sd=0.25); 
...
save.image(file="test_variance_diagnostics_5000_levene2.Rdata"); 
...
dev.copy2pdf(file="../manuscript/figures/test_variance_diagnostics_5000_levene2.pdf"); 
