...
AIC(log_models[[1]],log_models[[2]],log_models[[3]],log_models[[4]]); # model 4 is the winner, by a hair 
...
AIC(log_models[[1]],log_models[[2]],log_models[[3]],log_models[[4]]); # still model 4, by a hair 
