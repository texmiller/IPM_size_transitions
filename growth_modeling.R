...
rollmean<-rollapply(z0,width=10,mean,na.rm=T)
rollmean1<-rollapply(z1,width=10,mean,na.rm=T)
rollsd <-rollapply(z1,width=10,sd,na.rm=T); 
rollskew<-rollapply(z1,width=10,skewness,na.rm=T)
rollkurt<-rollapply(z1,width=10,kurtosis,na.rm=T)/3 - 1
