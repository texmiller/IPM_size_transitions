...
\end{lstlisting}
\verb|gamlss.dist:dSST| is a parameterization of the skewed $t$ which \verb|mu| and \verb|sigma| are the mean and standard deviation, respectively. 
...
Size data simulated from this model corresponded favorably to the real size data, much better than the pilot Gaussian model (Fig. \ref{fig:orchid_SST_fit}). 
