...
\begin{figure}[tbp]
	...
	\caption{Two versions of the same figure. TOP, log-linear model for SD as a function of fitted. BOTTOM, spline model for SD as a function of fitted; not sure what the wiggles in B are about. 
