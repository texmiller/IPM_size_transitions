...
\begin{enumerate}
	...
	\item Across one coral and three plant case studies, skewness and excess kurtosis were common features of size transition data: shrinking was more common than growing, and large changes in size were more common than a Gaussian model would predict. 
	\item %identify the conclusions and the wider implications
\end{enumerate}
