...
Furthermore, fitting the SHASH as a generalized additive model with \textbf{mgcv} allowed for flexible, non-monotonic size-dependence in the parameters that control skewness and kurtosis that, through iterations of trial and error, we found was necessary to generate simulated data that compared favorably to the real data. 
