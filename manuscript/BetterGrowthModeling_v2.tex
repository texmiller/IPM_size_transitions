...
Specifically, skewness switches from negative to positive across the size range, with smaller corals more likely to shrink than grow and larger corals more likely to grow than shrink. 
...
\begin{figure}[tbp]
	...
	standard deviation, NP skewness, and NP kurtosis of future size conditional on current size. Figure made by script \texttt{AkumalCorals\_qgam.R}.}
	\label{fig:coral_fit}
\end{figure} 
