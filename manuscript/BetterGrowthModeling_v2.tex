...
For a pilot Gaussian model, following a bit of model selection, we again used the \texttt{gaulss} family in \textbf{mgcv} to fit the mean and standard deviation of future size as second-order polynomials of current size. 
As expected based on previous analyses, visual analysis of the standardized residuals indicated negative skew, especially at larger sizes, and positive excess kurtosis (Fig. \ref{fig:lichen_diagnostics}). 
\begin{figure}[tbp]
	\centering
