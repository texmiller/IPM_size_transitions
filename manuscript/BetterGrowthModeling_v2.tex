...
In cases such as this, we recommend modeling variance as a function of expected future size, rather than initial size as we did with the lichens and cacti. 
...
However, there are some applications for which classical parametric regression would be preferable because regression parameters carry biological meaning.
