...
tests for trends in scaled residuals (despite wasting a month on honing suitable tests). Instead, we take the presence 
...
\textbf{NOTE: this is no longer needed, based on the advice to not do statistical tests for trends in scaled residuals. Another paper, maybe?} 
