...
for an unspecified trend in variance as a function of a covariate, \texttt{multiple\_levene\_test} and \texttt{multiple\_bs\_test},   
...
For example in our cactus case study, with over 4800 observed size transitions, we found very strong evidence ($p<0.001$) for a minuscule trend (explaining under 1\% of the variation in
the magnitude of scaled residuals) and therefore accepted the candidate standard deviation function.} 
