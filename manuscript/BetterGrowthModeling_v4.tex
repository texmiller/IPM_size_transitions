...
\usepackage[vmargin=1in,hmargin=1in,verbose,letterpaper,tmargin=2.54cm,bmargin=2.54cm,lmargin=2.54cm,rmargin=2.54cm]{geometry}
...
We illustrate our approach by revisiting three published case studies (and two additional case studies in the Supporting Information), including examples from our own previous work.
