...
will have zero mean and unit variance overall, and will exhibit no trends as a function of original size or fitted mean values. 
...
so scaled residuals will retain some variation in location and scale. Statistical tests
will detect that variation, given enough data. We therefore take for granted the presence of trends in mean and variance, 
and assess their importance by fitting nonparametric spline regression models for 
residuals (trend in mean) and absolute residuals (trend in variance) as a function of initial size or 
fitted value. The mean and variance functions can be accepted if the regression curves are nearly constant.} 
