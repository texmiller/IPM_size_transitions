...
\revise{\linelabel{cactus.uncertainty}The SHASH and Gaussian growth models predicted small differences in other life history traits, but these differences were small relative to the uncertainty captured by bootstrapped confidence intervals (Table \ref{tab:crossspp}).}
