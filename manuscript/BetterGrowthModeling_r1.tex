...
\renewcommand{\arraystretch}{1.5}
	...
	attributes cannot be computed from the model. Values in parenthesis are 95\% bootstrap confidence intervals, specifically the bias-corrected and accelerated (BCa) bootstrap confidence intervals 
	as described by \citep{bca-1996}. Table can be reproduced from scripts \texttt{crossspp\_growth.R, Vulpicida\_boot.R, Akumal\_corals\_boot.R}.}
	\centering
	...
	\hline 
	Coral                  & Gaussian  & \quad ---  &   17.3 (12.1, 24.3)   &  \quad ---  & 10.5 (9.41, 12.0)  & \quad --- \\ 
	(\textit{G. ventalina} & Improved  & \quad ---  &   17.5 (11.9, 24.2)   &  \quad ---  & 10.7 (9.52, 12.3)  & \quad --- \\
	\hline 
	\end{tabular}
	\endgroup
	\label{tab:crossspp}
