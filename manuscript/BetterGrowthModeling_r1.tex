...
\renewcommand{\arraystretch}{1.5}
	...
	{\textbf{Species}} & {\textbf{Growth model}} & {\textbf{$\lambda$}} & {\textbf{Lifespan}} & {\textbf{Lifetime reproductive output}} & {\textbf{Age at reproduction}} & {\textbf{Generation time}} \\ 
	\hline
	Lichen & Gaussian & 1.01 $\pm 0.01$ & 6.4 $\pm 2.1$ & 1.4 $\pm 0.7$ & 6.5 $\pm 0.4$ & 40.8 $\pm 7.1$ \\ 
	(\textit{V. pinastri}) & Improved & 1.00 $\pm 0.01$ & 5.4 $\pm 1.8$ & 1.0 $\pm 0.5$ & 6.4 $\pm 0.5$ & 36.6 $\pm 5.7$\\ 
	\hline
