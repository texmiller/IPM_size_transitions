...
This means that ecologists could assemble an IPM using familiar regression tools and leverage their capacity for covariates and hierarchical variance structures (i.e., random effects) to statistically describe growth, survival, reproduction, and other demographic transitions as functions of size, in the context of other factors (age, 
competition, temperature, etc.) affecting those rates. 
...
The regression sub-models for survival and reproduction only need to give the expected values of these vital rates as functions of size. 
...
Modeling that distribution should be done just as carefully as any other other part of building the model.
