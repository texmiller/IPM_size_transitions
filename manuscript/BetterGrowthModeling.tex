...
of a Normal(0,1) random variable usingthe sinh (hyperbolic sin) function and its inverse (asinh), as follows. The distribution family's base probability density  
...
``crosstalk'' between the kurtosis and skew parameters is weaker. As  a result, we found that parameter values were more reliably
recovered from data sets generated from known values of $\tau$ and $\lambda$. 
