...
We therefore use ``nonparametric'' (NP) measures of skew and kurtosis that are not so sensitive to extreme values: 
\be
\begin{aligned}
\mbox{NP Skewness} & = \frac{\mbox{Mean - Median}}{\sigma}, \\
