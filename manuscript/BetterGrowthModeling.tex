...
residuals should be Gaussian with mean zero and unit variance, with no skew or excess kurtosis in the future size distribution for any initial size.
...
\\
There are many ways that growth data may deviate from Gaussian. 
Visualizing these deviations, particularly patterns of size-dependence in skew and kurtosis, should guide the choice of an alternative distribution. 
