...
This means that ecologists could assemble an IPM using familiar regression tools, including covariates and hierarchical variance structures (i.e., random effects), to statistically describe growth, survival, reprduction, and other demographic transitions as functions of size. 
The relative ease and flexibility of the regression-based approach has facilitated a growing body of IPM literature that examines how biotic or abiotic drivers of demographic variation affect population dynamics (cite examples) and that explores the consequences of demographic heterogeneity associated with space, time, or individual identity \citep{crone2016contrasting,compagnoni2016effect}. 
The vital rate regressions are the bridge between data and population model; it is important to get them right.
