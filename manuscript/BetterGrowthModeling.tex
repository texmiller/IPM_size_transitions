...
More generally, whenever there are random effects and/or covariates besides initial size, it may be preferable to model the higher moments as functions of the expected value. 
We visualized these parameter relationships in Fig. \ref{fig:cactus_binned_JSU} and used them to guide specification of the likelihood function:
\begin{figure}
\centering
