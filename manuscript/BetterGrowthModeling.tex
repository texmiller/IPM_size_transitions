...
In this appendix we describe another option: fitting in a fixed-effects framework followed by shrinkage of coefficient estimates. The 
...
intercepts and $n$ annual slopes. 

Using this design matrix, it is easy to write a log likelihood function suitable for use with the \textbf{maxLik} package, 
...
We can then estimate parameters with \texttt{maxLik}, starting from a random guess: 
\begin{verbatim}
