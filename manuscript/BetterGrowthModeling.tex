...
\ee
This is eqn. (1) in \citet{gould-nichols-1989} in our notation, without the term resulting from temporal autocorrelation. 
...
to be drawn. Using that estimate, we can adjust the year-specific estimates to reduce (on average) the
impact of sampling error. There are two op
