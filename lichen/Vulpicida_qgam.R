...
S.05<-qgam(scaledResids~s(logarea.t0,k=6), data=XH,qu=0.05)
S.10<-qgam(scaledResids~s(logarea.t0,k=6), data=XH,qu=0.1)
S.25<-qgam(scaledResids~s(logarea.t0,k=6), data=XH,qu=0.25)
S.50<-qgam(scaledResids~s(logarea.t0,k=6), data=XH,qu=0.5) 
S.75<-qgam(scaledResids~s(logarea.t0,k=6), data=XH,qu=0.75)
S.90<-qgam(scaledResids~s(logarea.t0,k=6), data=XH,qu=0.9) 
S.95<-qgam(scaledResids~s(logarea.t0,k=6), data=XH,qu=0.95)
